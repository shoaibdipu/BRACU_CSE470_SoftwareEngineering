package com.dineout.code.view.admin;
...
import com.dineout.code.controller.admin.AdminPanelActivity;
                                        ...
                                        for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                                            ...
                                            if (employee != null) {
                                                if (employee.getType().equals("Hall Manager") && txtEmailLogin.getText().toString().equals(employee.getEmail())) {
                                                    ...
                                                    Intent i = new Intent(LoginActivity.this, com.dineout.code.view.hall.ManagerInterface.class);
                                            ...
                                            if (employee != null) {
                                                if (employee.getType().equals("Head Chef") && txtEmailLogin.getText().toString().equals(employee.getEmail())) {
                                                    ...
                                                    Intent i = new Intent(LoginActivity.this, com.dineout.code.controller.kitchen.MainActivity.class);
                                                    i.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                                                    startActivity(i);
                                                }
                                            }
